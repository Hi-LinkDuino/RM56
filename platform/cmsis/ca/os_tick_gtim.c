...
int32_t OS_Tick_Setup (uint32_t freq, IRQHandler_t handler) {
  ...
  *timer1_reset = 0x10000000;
  ...
  GTIM_Clock = 6500000UL;
#elif defined(CHIP_BEST2003)
  GTIM_Clock = 6000000UL;
#endif
#endif
  ...
  *ts_gen = 0x3;
  //while(1);
  /*
  volatile uint32_t *ts_val_low = (volatile uint32_t *)(DSP_TIMESTAMP_GEN_BASE + 0x08);
  volatile uint32_t *ts_val_up = (volatile uint32_t *)(DSP_TIMESTAMP_GEN_BASE + 0x0C);
while (1) {
  //timestamp_low = *ts_val_low;
  //timestamp_up = *ts_val_up;
}
*/
