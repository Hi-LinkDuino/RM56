...
public:
    ...
    public:
        virtual void OnChange(UIAbstractProgress& view) = 0;
    ...
    {
        changeListener_ = onChangeListener;
    }
    ...
    void SetDragTriggerListener(bool b){
        dragTriggerListener_ = b;
    }
    bool GetDragTriggerListener(){
        return dragTriggerListener_;
    }
#endif
...
protected:
    ...
    int32_t lastValue_;
#ifdef OH_UI_PROGRESS_TOUCHABLE
    OnChangeListener *changeListener_;
    bool disabled_; //true: no click&drag, false default
    bool dragTriggerListener_; //true: each move will tigger onChangeListener. false default, means only drag end trigger listener
    bool dragStarted_;
#endif
};
} // namespace OHOS
