...
/**
 * @brief Enumerates radius direction.
 *
 * @since 1.0
 * @version 1.0
 */
enum RadiusDirectionType : uint8_t {
    /** radius default*/
    RADIUS_DIRECTION_NONE = 0,
    /** Noly left radius */
    RADIUS_DIRECTION_LEFT=1,
    /** Noly right radius */
    RADIUS_DIRECTION_RIGHT=2,
    /** Noly top radius */
    RADIUS_DIRECTION_TOP=3,
    /** Noly bottom radius */
    RADIUS_DIRECTION_BOTTOM=4
};
...
public:
    ...
    void TranslateValueToType(int16_t radiusDirection);
