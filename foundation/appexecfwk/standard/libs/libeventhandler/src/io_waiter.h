...
#ifndef FOUNDATION_APPEXECFWK_LIBS_LIBEVENTHANDLER_SRC_IO_WAITER_H
#define FOUNDATION_APPEXECFWK_LIBS_LIBEVENTHANDLER_SRC_IO_WAITER_H
...
#endif  // #ifndef FOUNDATION_APPEXECFWK_LIBS_LIBEVENTHANDLER_SRC_IO_WAITER_H
