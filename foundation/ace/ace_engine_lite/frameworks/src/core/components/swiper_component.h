...
private:
    ...
    static const char * const FUNC_SWIPETO; 
    static const char * const INDEX_SWIPETO;
     static JSValue swipePageTo(const JSValue func, const JSValue dom, const JSValue args[], const jerry_length_t size);
