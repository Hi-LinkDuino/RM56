...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_SCROLL_CREATOR_H
...
// creator for create scroll component.
class ScrollCreator {
public:
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_SCROLL_CREATOR_H
