...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_TRANSFORM_CREATOR_H
...
public:
    ...
    static void performCreateFromJson(
        const std::string& key, const JsonValue& json, RefPtr<TransformComponent>& component);
};

} // namespace OHOS::Ace

#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_TRANSFORM_CREATOR_H
