...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_MARQUEE_CREATOR_H
...
class MarqueeCreator {
public:
    static RefPtr<Component> CreateFromJson(const JsonValue& json, const JsonComponentFactory& factory);
    static void InitStyle(RefPtr<MarqueeComponent> marquee);
};

} // namespace OHOS::Ace

#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_MARQUEE_CREATOR_H
