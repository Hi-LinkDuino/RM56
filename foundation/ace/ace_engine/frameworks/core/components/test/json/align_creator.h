...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_ALIGN_CREATOR_H
...
// creator for create align component.
class AlignCreator {
public:
    static RefPtr<Component> CreateFromJson(const JsonValue& json, const JsonComponentFactory& factory);
    static Alignment GetAlignmentFromJson(const JsonValue& componentJson);
};

} // namespace OHOS::Ace

#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_ALIGN_CREATOR_H
