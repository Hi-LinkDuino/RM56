...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_VIDEO_CREATOR_H
...
// creator for create image component.
class VideoCreator {
public:
...
private:
    ...
    static void BuildEventFromJson(const JsonValue& json, const RefPtr<VideoComponent>& video);
};

} // namespace OHOS::Ace

#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_VIDEO_CREATOR_H
