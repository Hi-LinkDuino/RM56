...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_FLEX_CREATOR_H
...
// creator for create flex component.
class RowCreator {
public:
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_FLEX_CREATOR_H
