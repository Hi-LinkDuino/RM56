...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_BOX_CREATOR_H
...
// creator for create box component.
class BoxCreator {
public:
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_BOX_CREATOR_H
