...
#ifndef FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_TOUCH_LISTENER_CREATOR_H
...
class TouchListenerCreator final {
public:
...
#endif // FOUNDATION_ACE_FRAMEWORKS_CORE_COMPONENTS_TEST_JSON_TOUCH_LISTENER_CREATOR_H
