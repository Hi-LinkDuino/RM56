...
private:
    ...
    ErrCode GetStateInner(MessageParcel &data, MessageParcel &reply);
    ...
    using BluetoothHostFunc = ErrCode (BluetoothMapMseStub::*)(MessageParcel &data, MessageParcel &reply);
