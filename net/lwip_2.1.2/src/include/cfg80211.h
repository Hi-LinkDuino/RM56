...
struct cfg80211_ops {
	...
	void	(*set_data_filter)(struct wiphy *wiphy,
				   struct net_device *dev,
				   void *data, int len);
#ifdef CONFIG_CW1200_TESTMODE
	int	(*update_acm_up)(struct wiphy *wiphy, struct net_device *dev,
				 u8 enable_up, u8 update_up);
#endif /*CONFIG_CW1200_TESTMODE*/
};
...
extern struct cfg80211_registered_device * wiphy_rdev(void);
extern struct wiphy *get_wiphy(void);
extern unsigned int get_channel(void);
 ...
 */
const u8 *_cfg80211_find_ie(u8 eid, const u8 *ies, int len);
#define cfg80211_find_ie _cfg80211_find_ie
...
extern const struct ieee80211_reg_rule *freq_reg_info(struct wiphy *wiphy,
						      u32 center_freq);
...
void cfg80211_send_sa_query(struct net_device *dev, const u8 *buf, size_t len);
...
extern void dev_printk(const struct device *dev,
		       const char *fmt, ...);

#define wiphy_printk(level, wiphy, format, args...)		\
	dev_printk(&(wiphy)->dev, format, ##args)
#define wiphy_emerg(wiphy, format, args...)			\
	dev_printk(&(wiphy)->dev, format, ##args)
#define wiphy_alert(wiphy, format, args...)			\
	printk(KERN_ALERT, format, ##args)
#define wiphy_crit(wiphy, format, args...)			\
	printk(KERN_CRITICAL, format, ##args)
#define wiphy_err(wiphy, format, args...)			\
	printk(KERN_ERR, format, ##args)
#define wiphy_warn(wiphy, format, args...)			\
	printk(KERN_WARN, format, ##args)
