...
#define WLAN_CAPABILITY_RADIO_MEASUREMENT	(1<<12)
#define WLAN_CAPABILITY_DSSS_OFDM	(1<<13)
#define WLAN_CAPABILITY_DELAYED_BLOCK_ACK	(1<<14)
#define WLAN_CAPABILITY_IMM_BLOCK_ACK	(1<<15)
/* measurement */
...
enum ieee80211_eid {
	...
	WLAN_EID_VHT_OPERATING_MODE_NOTIFICATION = 199,
	...
	WLAN_EID_OVERLAPPING_BSS_SCAN_PARAMS = 74,
	...
	WLAN_EID_SUPPORTED_OPERATING_CLASSES = 59,
	WLAN_EID_EXT_CHANSWITCH_ANN = 60,
	WLAN_EID_SECONDARY_CHANNEL_OFFSET = 62,
	WLAN_EID_TFS_REQ = 91,
	WLAN_EID_WNMSLEEP = 93,
	WLAN_EID_VHT_AID = 197,
	WLAN_EID_20_40_BSS_INTOLERANT = 73,
...
enum ieee80211_radio_measurement_actioncode {
	WLAN_ACTION_RADIO_MEASUREMENT_REQUEST = 0,
	WLAN_ACTION_RADIO_MEASUREMENT_REPORT = 1,
	WLAN_ACTION_LINK_MEASUREMENT_REQUEST = 2,
	WLAN_ACTION_LINK_MEASUREMENT_REPORT = 3,
	WLAN_ACTION_NEIGHBOR_REPORT_REQUEST = 4,
	WLAN_ACTION_NEIGHBOR_REPORT_RESPONSE = 5,
};
...
/**
 * ieee80211_get_BSSID - get pointer to BSSID
 * @hdr: the frame
 *
 * Given an 802.11 frame, this function returns the offset
 * to the destination address (DA). It does not verify that
