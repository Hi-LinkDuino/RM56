...
int net_notice_server_get_file(net_dump_handle_t net_dump_handle, char *get_file_name);
int net_get_data(net_dump_handle_t net_dump_handle,char *get_data_buffer,int get_len);
