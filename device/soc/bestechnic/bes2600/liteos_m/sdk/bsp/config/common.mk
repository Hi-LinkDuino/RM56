...
export CONSOLE_USB_CDC ?= 0
ifeq ($(CONSOLE_USB_CDC),1)
KBUILD_CPPFLAGS += -DCONSOLE_USB_CDC -DDUMP_LOG_ENABLE
ifeq ($(PROGRAMMER),1)
KBUILD_CPPFLAGS += -DCRASH_DUMP_ENABLE
endif
endif
...
ifeq ($(DCOMMS),1)
export DCOMMS
KBUILD_CPPFLAGS +=-DBLE_DCOMMS
endif

ifeq ($(DCOMMC),1)
export DCOMMC
KBUILD_CPPFLAGS +=-DBLE_DCOMMC
endif
...
ifeq ($(SDK),1)
export FORCE_TO_USE_LIB ?= 1
endif

ifdef DEV
include $(srctree)/config/bfd_build/$(CHIP)-addrmap.mk
endif
