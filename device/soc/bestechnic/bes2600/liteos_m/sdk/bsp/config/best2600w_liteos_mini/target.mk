...
export ARM_CMSE_TARGET ?= best2600w_liteos_mini_se
...
# use the same cmcp image as best2600w_liteos in which BT_RAMRUN is enabled
BT_RAMRUN_SIZE ?= 0x80000
export RAMV_SIZE := 0x30000
...
export USB_AUDIO_SEND_ENABLE ?= 0
...
ifeq ($(PSRAM_ENABLE), 1)
KBUILD_CPPFLAGS += -DOS_HEAP_SIZE=0x200000
else
...
# **************************
export WIFI_VOICE_SUPPORT ?= 0
export LFS_ON_FLASH ?= 0
