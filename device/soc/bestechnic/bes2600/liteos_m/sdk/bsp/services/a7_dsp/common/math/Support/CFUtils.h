/*
	Copyright (C) 2000-2021 Apple Inc. All Rights Reserved. Not to be used or disclosed without permission from Apple.
*/
...
//---------------------------------------------------------------------------------------------------------------------------
/*!	@function	CFDictionaryGetEmpty
	@abstract	Returns an empty CFDictionary.
 */
CFDictionaryRef CFDictionaryGetEmpty(void);

//---------------------------------------------------------------------------------------------------------------------------
/*!	@function	CFDictionaryGetOrCopyBytes
	@abstract	
 */
const uint8_t*
