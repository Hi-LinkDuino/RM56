...
#ifdef BLE_DCOMMS
#define CFG_PRF_DATACOMM_SERVER
#endif
...
/// Data Comm Service Server Role
#if defined(CFG_PRF_DATACOMM_SERVER)
#define BLE_DATACOMM_SERVER     1
#else
#define BLE_DATACOMM_SERVER     0
#endif // defined(CFG_PRF_DATACOMM_SERVER)
...
enum rwprf_id
{
    ...
    #if (BLE_DATACOMM_SERVER)
    PRF_ID_DATACOMM,
    #endif //(BLE_DATACOMM_SERVER)
