...
#ifdef CONFIG_FLASH_REMAP
extern void _flash_remap_start(enum HAL_FLASH_ID_T id,uint32_t addr, uint32_t len);
extern void _flash_remap_done(enum HAL_FLASH_ID_T id,uint32_t addr, uint32_t len);
#endif
