...
#ifdef BLE_DCOMMS
#define CFG_APP_DATACOMM_SERVER
#endif
...
#if defined(CFG_APP_DATACOMM_SERVER)
#define BLE_APP_DATACOMM_SERVER           1
#else // defined(CFG_APP_DATACOMM_SERVER)
#define BLE_APP_DATACOMM_SERVER           0
#endif // defined(CFG_APP_DATACOMM_SERVER)
