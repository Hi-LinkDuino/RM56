...
typedef enum {
    OHOS_BLE_LINK_UNKNOW,
    OHOS_BLE_LINK_CONNECTED,
    OHOS_BLE_LINK_DISCONNECTED,
} BleLinkState;
 ...
 * @since 3
 */
typedef void (*LinkStateChangedCallback)(int connId, const BdAddr *bdAddr, BleLinkState linkState);
...
typedef struct {
    ...
    /** 链路状态发生变化时回调 */
    LinkStateChangedCallback linkStateChangedCb;
