...
#define SERVER_NAME "192.168.0.106"
...
int ssl_client_main( void )
{
    ...
    ret = mbedtls_x509_crt_parse( &cacert, (const unsigned char *) root_ca,
                          root_ca_len );
    if( ret < 0 )
    {
