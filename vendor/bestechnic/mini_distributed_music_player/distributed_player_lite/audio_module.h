...
public:
    ...
    static JSIValue Oncallback(const JSIValue thisVal, const JSIValue *args, uint8_t argsSize);
    static JSIValue PlayRemote(const JSIValue thisVal, const JSIValue *args, uint8_t argsSize);

    static  void OnPlayRemote(int32_t data);
...
private:
    ...
    static AudioCallbackInfo audiocallbackinfo_;
};
