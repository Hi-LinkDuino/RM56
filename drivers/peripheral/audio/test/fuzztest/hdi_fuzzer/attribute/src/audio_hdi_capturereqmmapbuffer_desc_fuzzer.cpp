...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    struct AudioMmapBufferDescripter *descFuzz = reinterpret_cast<struct AudioMmapBufferDescripter *>(dataFuzz);
    capture->attr.ReqMmapBuffer((AudioHandle)capture, size, descFuzz);
