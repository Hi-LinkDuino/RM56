...
int iperf_udp_server_send_report(struct iperf_stream *sp);
void iperf_udp_init_client_header(struct iperf_stream *sp);
void iperf_udp_init_server_header(struct iperf_stream *sp);
