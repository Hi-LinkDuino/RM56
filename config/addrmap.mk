#included by Makefile after common.mk included, since xxx_SECTION_SIZE defined in config/common.mk
...
export LFS_FLASH_TOTAL_SIZE = $(shell $(call hex_calc,$(COMBO_SECTION_OFFSET)-$(LFS_FLASH_BASE_ADDR)))
