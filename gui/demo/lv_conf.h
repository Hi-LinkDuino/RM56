...
#if LV_TICK_CUSTOM
#if defined(ARDUINO)
#  define LV_TICK_CUSTOM_INCLUDE       "lv_app.h"    /*Header for the system time function*/
#  define LV_TICK_CUSTOM_SYS_TIME_EXPR (lv_sys_time())     /*Expression evaluating to current system time in ms*/
#elif defined(_WIN32)
...
#endif
#  define LV_TICK_CUSTOM_SYS_TIME_EXPR (lv_sys_time())
...
#ifndef _WIN32
#define LV_ASSERT_HANDLER_INCLUDE "hal_trace.h"
